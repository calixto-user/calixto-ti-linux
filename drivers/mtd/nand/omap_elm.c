...
static int __init elm_driver_init(void)
{
       return platform_driver_register(&elm_driver);
}
postcore_initcall(elm_driver_init);

static void __exit elm_driver_exit(void)
{
       platform_driver_unregister(&elm_driver);
}
module_exit(elm_driver_exit);
